...
-- Tiempo de generación: 09-02-2021 a las 02:16:47
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `nombreFantasia` text COLLATE utf8_spanish_ci NOT NULL,
  `impositivo` text CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `direccion` text CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `provincia` text CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `clientes` (`id`, `razonSocial`, `nombreFantasia`, `impositivo`, `direccion`, `provincia`, `pais`, `email`, `telefono`, `tipoDocumento`, `numeroDocumento`, `foto`, `fecha`) VALUES
(1, 'ff', 'ff', 'IVA Responsable Inscripto', 'colon 254', 'Azul', 'Argentina', 'fede_bellezza@hotmail.com', '02281551798', 'cuit', '1234', '', '2021-01-30 19:08:02'),
(2, 'aa', 'aa', 'IVA Responsable no Inscripto', 'colon 254', 'Azul', 'Argentina', 'fede_bellezza@hotmail.com', '02281551798', 'dni', '123', '', '2021-01-30 19:09:15'),
(3, 'bb', 'bb', 'IVA no Responsable', 'colon 254', 'Azul', 'Argentina', 'fede_bellezza@hotmail.com', '02281551798', 'cuit', '9876', '', '2021-01-30 19:09:52'),
(4, 'cc', 'dd', '4', 'Calle 1 N°418 - PIDA2', 'Azul', 'Argentina', 'fede_bellezza@hotmail.com', '02281551798', 'cuit', '1234', '', '2021-01-30 19:12:44'),
(5, 'ff', 'ff', 'Sujeto no Categorizado', 'colon 254', 'Azul', 'Argentina', 'fede_bellezza@hotmail.com', '02281551798', 'cuit', '12345', '', '2021-01-30 21:12:16'),
(6, 'fff', 'fds', 'Responsable Monotributo', 'colon 254', 'Azul', 'Argentina', 'fede_bellezza2@hotmail.com', '02281551798', 'cuit', '543', '', '2021-01-30 21:17:28'),
(7, 'lpm', 'lpm', 'Sujeto no Categorizado', 'colon 254', 'Azul', 'Argentina', 'fede_bellezza@hotmail.com', '02281551798', 'cuit', '1234567', '', '2021-01-30 22:25:42'),
(8, 'qwerty', 'qwerty', 'Pequeño Contribuyente Eventual', 'Calle 1 N°418 - PIDA2', 'Azul', 'Argentina', 'fede_bellezza1@hotmail.com', '02281551798', 'cuit', '1235', '', '2021-01-30 22:26:26'),
(9, 'mail', 'mail', 'Responsable Monotributo', 'colon 254', 'Azul', 'Argentina', 'mail@mail.com', '02281551798', 'cuit', '123', '', '2021-01-30 22:32:02'),
(10, 'desa', 'desa', 'IVA Liberado - Ley Nº 19.640', 'colon 254', 'Azul', 'Argentina', 'fede123@hotmail.com', '02281551798', 'cuit', '1234', '', '2021-01-30 22:49:18'),
(11, 'admin', 'admin', 'Pequeño Contribuyente Eventual', 'colon 254', 'Azul', 'Argentina', 'fede1@hotmail.com', '02281551798', 'cuit', '123456', '', '2021-01-30 23:11:02'),
(12, 'ww', 'www', 'Pequeño Contribuyente Eventual Social', 'colon 254', 'Azul', 'Argentina', 'fedewww@hotmail.com', '02281551798', 'cuit', '1234', '', '2021-01-31 12:41:08'),
(13, 'qq', 'qqqq', 'Monotributista Social', 'Calle 1 N°418 - PIDA2', 'Azul', 'Argentina', 'qq@hotmail.com', '02281551798', 'cuit', '12345', '', '2021-01-31 12:49:09'),
(14, 'asd', 'asd', 'Cliente del Exterior', 'colon 254', 'Azul', 'Argentina', 'asd@hotmail.com', '02281551798', 'cuit', '1234', '', '2021-01-31 12:53:23'),
(15, 'rr', 'rr', 'Responsable Monotributo', 'colon 254', 'Azul', 'Argentina', 'rr@hotmail.com', '02281551798', 'cuit', '12345', 'vistas/img/clientes/rr@hotmail.com/.png', '2021-01-31 12:56:29');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `clientesold`
--

DROP TABLE IF EXISTS `clientesold`;
CREATE TABLE IF NOT EXISTS `clientesold` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla `clientesold`
--

INSERT INTO `clientesold` (`id`, `nombre`, `cuit`, `email`, `telefono`, `direccion`, `ultima_login`) VALUES
...
INSERT INTO `pack` (`id`, `nombre`, `detalle`, `precio`) VALUES
(1, 'primeroEE', '1\r\n2\r\n3', '500'),
(4, 'pack estrella', '<p>1</p><p>2</p><p>3</p><p><br></p>', '1300'),
(3, 'Tercero', '1234\r\n456', '1000');
...
(3, '¿Cómo Hago una Factura?', '<p><b>No factures</b>, vende en negro!!!</p>'),
(2, '¿Hay que liquidar IVA?', '<p>nunca!!! el iva se hizo para venderlo</p>');
...
(1, 'Federico F', 'Bellezza', 'fede_bellezza@hotmail.com', '$2a$07$asxx54ahjppf45sd87a5auXBm1Vr2M1NV5t/zNQtGHGpS5fFirrbG', 'Administrador', 1, 'vistas/img/usuarios/fede_bellezza@hotmail.com/782.png', '2021-02-08 18:00:06', '2020-03-27 03:28:07'),
(14, 'Cosme', 'Fuanito', 'cosme@mail.com', '$2a$07$asxx54ahjppf45sd87a5au6cjNITHuFDUELKrV0PJmrYi9frtxSjC', 'Administrador', 1, 'vistas/img/usuarios/cosme@mail.com/409.jpg', '0000-00-00 00:00:00', '2021-01-27 01:04:42'),
(15, 'Charo', 'Bellezza', 'charo@gmail.com', '$2a$07$asxx54ahjppf45sd87a5auXBm1Vr2M1NV5t/zNQtGHGpS5fFirrbG', 'Administrador', 0, 'vistas/img/usuarios/charo@gmail.com/872.jpg', '0000-00-00 00:00:00', '2021-01-27 01:53:40'),
...
(11, 'luca r', 'Prodan', 'luca@gmail.com', '$2a$07$asxx54ahjppf45sd87a5auJRR6foEJ7ynpjisKtbiKJbvJsoQ8VPS', 'Especial', 1, 'vistas/img/usuarios/luca@gmail.com/726.png', '0000-00-00 00:00:00', '2020-05-10 13:10:50'),
(12, 'Gustavo', 'Cerati', 'gustavo@gmail.com', '$2a$07$asxx54ahjppf45sd87a5auyMGRqy.m0N/UQn29PX.j6Bq3jVEgeZ6', 'Cliente', 1, 'vistas/img/usuarios/gustavo@gmail.com/743.jpg', '2020-05-31 23:47:11', '2020-05-10 13:11:42');
COMMIT;
